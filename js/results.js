// ============================================================
// FILE: js/results.js
// PURPOSE: Results page — reads sessionStorage, renders 3 result
//          cards, opens/closes detail modal, handles share button,
//          EmailJS send, and retake quiz logic
// DEPENDS ON: config.js (EmailJS keys), emailjs CDN
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Enforce percentage constraints: round to 5, clamp 55–95, no duplicates
...
function openModal(item) {
  ...
  // Roles tags — populates static #m-growth-roles container
  const rolesContainer = document.getElementById('m-growth-roles');
  if (rolesContainer) {
    ...
    if (!item.roles?.length) rolesContainer.innerHTML = '<span class="role-tag">Not specified</span>';
  }
